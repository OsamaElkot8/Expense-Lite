...
class AppLocalizations {
  ...
  String get totalBalance => _getLocalizedValue('Total Balance', 'الرصيد الإجمالي');
  String get income => _getLocalizedValue('Income', 'الدخل');
  String get expenses => _getLocalizedValue('Expenses', 'المصروفات');
  String get recentExpenses => _getLocalizedValue('Recent Expenses', 'المصروفات الأخيرة');
  ...
  String get attachReceipt => _getLocalizedValue('Attach Receipt', 'إرفاق إيصال');
  String get uploadImage => _getLocalizedValue('Upload image', 'رفع صورة');
  String get save => _getLocalizedValue('Save', 'حفظ');
  String get selectCategory => _getLocalizedValue('Select Category', 'اختر الفئة');
  ...
  String get pleaseFillAllFields => _getLocalizedValue('Please fill all fields', 'يرجى ملء جميع الحقول');
